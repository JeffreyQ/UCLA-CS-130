...
class PollResponse extends React.Component {
    ...
    renderResponseComponent = poll => {    
        switch (poll.form_type) {
            ...
            // case "selectAll":
            //     return <SelectAllResponse poll={poll} users={this.props.navigation.getParam('subscribers')}/>
            // case "freeResp":
            //     return <ShortAnswerResponse poll={poll} users={this.props.navigation.getParam('subscribers')}/>
            // case "multChoice":
            //     return <TrueFalseResponse poll={poll} users={this.props.navigation.getParam('subscribers')}/>
            default:
                return null
        }
    }
